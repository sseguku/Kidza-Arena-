  ...
  "inline-flex shrink-0 items-center justify-center gap-2 rounded-lg text-sm font-semibold whitespace-nowrap transition-all outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        pitch:
          "bg-gradient-pitch text-pitch-foreground shadow-md hover:opacity-90 active:scale-[0.98]",
        adventure:
          "bg-gradient-adventure text-adventure-foreground shadow-md hover:opacity-90 active:scale-[0.98]",
        community:
          "bg-community text-community-foreground shadow-sm hover:bg-community/90 active:scale-[0.98]",
        value:
          "bg-value text-value-foreground shadow-sm hover:bg-value/90 active:scale-[0.98]",
        fun: "bg-fun text-fun-foreground shadow-md hover:bg-fun/90 active:scale-[0.98]",
        competitive:
