  ...
  "flex flex-col gap-6 rounded-xl border bg-card py-6 text-card-foreground shadow-sm transition-shadow",
  {
    variants: {
      variant: {
        ...
        adventure:
          "border-adventure/20 bg-adventure/5 hover:shadow-md hover:shadow-adventure/10",
        community: "border-community/20 bg-community/5",
        value: "border-value/30 bg-value/10",
        fun: "border-fun/20 bg-fun/5",
        elevated: "border-border shadow-md hover:shadow-lg",
        interactive:
          "cursor-pointer border-border hover:border-primary/30 hover:shadow-md active:scale-[0.99]",
        gradient:
